...
class TEST(IStrategy):
    ...
    def indicator_space() -> List[Dimension]:
        return [
            ...
            DecimalParameter(0.005, 0.04, name='buy_bb40_bbdelta_close'),
            DecimalParameter(0.01, 0.03, name='buy_bb40_closedelta_close'),
            DecimalParameter(0.2, 0.4, name='buy_bb40_tail_bbdelta'),
            DecimalParameter(0.8, 1.1, name='buy_bb20_close_bblowerband'),
            IntParameter(18, 36, name='buy_bb20_volume'),
            DecimalParameter(34.0, 60.0, name='buy_rsi_diff'),
            DecimalParameter(0.005, 0.05, name='buy_min_inc'),
            DecimalParameter(40.0, 70.0, name='buy_rsi_1h'),
            DecimalParameter(30.0, 40.0, name='buy_rsi'),
            DecimalParameter(36.0, 65.0, name='buy_mfi')
    ...
    def sell_indicator_space() -> List[Dimension]:
        return[
            DecimalParameter(72.0, 90.0, name='sell_rsi_main')
            ]
