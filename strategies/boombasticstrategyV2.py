...
class BoomBasticStrategyV2(IStrategy):
    INTERFACE_VERSION = 3
...
class LeveragedIchiV2x(BoombasticStrategy):
    ...
    def leverage(
        ...
        **kwargs,
        ...
        """
        return 2.0
class LeveragedIchiV3x(BoomBasticStrategy):
    ...
    def leverage(
        ...
        **kwargs,
        ...
        """
        return 3.0
class LeveragedIchiV4x(BoomBasticStrategy):
    ...
    def leverage(
        ...
        **kwargs,
        ...
        """
        return 4.0
class LeveragedIchiV10x(BoomBasticStrategy):
    ...
    def leverage(
        ...
        **kwargs,
        ...
        """
        return 10.0
class LeveragedIchiV30x(BoomBasticStrategy):
    ...
    def leverage(
        ...
        **kwargs,
        ...
        """
        return 30.0
class LeveragedIchiVTenPercentMaxLeverage(BoomBasticStrategy):
