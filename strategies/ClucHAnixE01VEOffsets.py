...
class ClucHAnixE01VEOffsets(IStrategy):
...
class ClucHAnix_ETH(ClucHAnixE01VEOffsets):
...
class ClucHAnix_BTC(ClucHAnixE01VEOffsets):
...
class ClucHAnix_USD(ClucHAnixE01VEOffsets):
