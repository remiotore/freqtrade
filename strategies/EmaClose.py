...
class EmaClose(IStrategy):
    ...
    trailing_stop_positive_offset = 0.2  # Disabled / not configured
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['limiter'] = dataframe['ema5']*1.01
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (dataframe['ema5'] > dataframe['ema9']) & 
                (dataframe['close'] < dataframe['limiter']) &
