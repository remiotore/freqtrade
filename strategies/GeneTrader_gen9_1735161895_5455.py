...
class GeneTrader_gen9_1735161895_5455(IStrategy):
    """
    ...
    buy_rmi = IntParameter(30.0, 50.0, default=30, space='buy', optimize=True)
    buy_cci = IntParameter(-135.0, -90.0, default=-125, space='buy', optimize=True)
    buy_srsi_fk = IntParameter(30.0, 50.0, default=37, space='buy', optimize=True)
    buy_cci_length = IntParameter(25.0, 45.0, default=35, space='buy', optimize=True)
    buy_rmi_length = IntParameter(8.0, 20.0, default=8, space='buy', optimize=True)

    buy_bb_width = DecimalParameter(0.065, 0.135, default=0.111, space='buy', optimize=True)
    buy_bb_delta = DecimalParameter(0.018, 0.035, default=0.035, space='buy', optimize=True)
    
    buy_roc_1h = IntParameter(-25.0, 200.0, default=26, space='buy', optimize=True)
    buy_bb_width_1h = DecimalParameter(0.3, 2.0, default=1.4, space='buy', optimize=True)

    #ClucHA
    is_optimize_clucha = False
    buy_clucha_bbdelta_close = DecimalParameter(0.0005, 0.02, default=0.01, space='buy', optimize=True)
    buy_clucha_bbdelta_tail = DecimalParameter(0.7, 1.0, default=0.875, space='buy', optimize=True)
    ...
    buy_closedelta = DecimalParameter(12.0, 18.0, default=15.6, space='buy', optimize=True)
    
    # buy params
    rocr_1h = DecimalParameter(0.5, 1.0, default=0.89, space='buy', optimize=True)
    rocr1_1h = DecimalParameter(0.5, 1.0, default=0.66, space='buy', optimize=True)
    ...
    bbdelta_tail = DecimalParameter(0.7, 1.0, default=0.875, space='buy', optimize=True)
    close_bblower = DecimalParameter(0.0005, 0.02, default=0.001, space='buy', optimize=True)

    # sell params
    sell_fisher = DecimalParameter(0.1, 0.5, default=0.197, space='sell', optimize=True)
    sell_bbmiddle_close = DecimalParameter(0.97, 1.1, default=1.076, space='sell', optimize=True)
    
    #Deadfish
    sell_deadfish_bb_width = DecimalParameter(0.03, 0.75, default=0.08, space='sell', optimize=True)
    sell_deadfish_profit = DecimalParameter(-0.15, -0.05, default=-0.07, space='sell', optimize=True)
    sell_deadfish_bb_factor = DecimalParameter(0.9, 1.2, default=1.03, space='sell', optimize=True)
    ...
    base_nb_candles_sell = IntParameter(8.0, 50.0, default=42, space='sell', optimize=True)
    low_offset = DecimalParameter(0.985, 0.995, default=0.989, space='buy', optimize=True)
    high_offset = DecimalParameter(1.005, 1.015, default=1.005, space='sell', optimize=True)
    high_offset_2 = DecimalParameter(1.01, 1.02, default=1.02, space='sell', optimize=True)
    
    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.24, space='sell', optimize=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.36, space='sell', optimize=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.1, default=0.06, space='sell', optimize=True)

    sell_trail_profit_min_2 = DecimalParameter(0.04, 0.1, default=0.05, space='sell', optimize=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.1, space='sell', optimize=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.15, space='sell', optimize=True)

    # hard stoploss profit
    pHSL = DecimalParameter(-0.5, -0.04, default=-0.461, space='sell', optimize=True)
    ...
    pPF_2 = DecimalParameter(0.04, 0.1, default=0.087, space='sell', optimize=True)
