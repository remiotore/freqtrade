...
class maqun999(IStrategy):
    ...
    trailing_stop_positive_offset = 0.06 # 盈利达到 0.5% 开始追踪
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # 条件 1: 持仓 6 小时且亏损超过 3% 卖出
        six_hour_loss_condition = (
            (dataframe['close'] < dataframe['open'] * 0.97) &  # 亏损 3%
            (dataframe.index - dataframe.index[0] >= pd.Timedelta(hours=12))  # 持仓时间大于 6 小时
        )
        conditions_exit_long.append(six_hour_loss_condition)
