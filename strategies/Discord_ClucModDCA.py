...
class ClucModDCA(IStrategy):
    ...
    def informative_pairs(self):
        ...
        informative_pairs += [("BTC-PERP", "1m")]
        informative_pairs += [("BTC-PERP", "1d")]
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        ### BTC protection
        dataframe['btc_1m']= self.dp.get_pair_dataframe('BTC-PERP', timeframe='1m')['close']
        btc_1d = self.dp.get_pair_dataframe('BTC-PERP', timeframe='1d')[['date', 'close']].rename(columns={"close": "btc"}).shift(1)
