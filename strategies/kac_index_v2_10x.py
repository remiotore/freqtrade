...
class kac_index_v2_10x(IStrategy):
    trailing_stop = False
    #    minimal_roi = {
    #        "0": 4.05,
    #        "6000": 3.42,
    ...
    #        "19440": -0.02
    #    }
    minimal_roi = {'0': 4.05, '15': 1, '30': 0.8, '60': 0.5, '90': 0.37, '2880': -0.3}
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        return dataframe
    plot_config = {'main_plot': {}, 'subplots': {'CCI': {'CCI': {'color': '#53387a', 'type': 'line'}, 'C-CCI': {'color': '#ff0000', 'type': 'scatter', 'scatterSymbolSize': 6}, 'I-CCI': {'color': '#00ff37', 'type': 'scatter'}}, 'ATR': {'ATR': {'color': '#eba1b1'}, 'I-ATR': {'color': '#15ff00', 'type': 'line'}, 'C-ATR': {'color': '#ff0000', 'type': 'line'}}}}