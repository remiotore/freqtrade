...
class TrailingBuyStratCluc_172(IStrategy):
...
class ClucHAnix_ETH(TrailingBuyStratCluc_172):
...
class ClucHAnix_BTC(TrailingBuyStratCluc_172):
...
class ClucHAnix_USD(TrailingBuyStratCluc_172):
...
class TrailingBuyStratCluc(TrailingBuyStratCluc_172):
