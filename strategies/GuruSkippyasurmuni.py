...
Jerson
ScalpingStrategy
docker-compose run --rm freqtrade download-data --timerange=20230101-20231201 --config user_data/config.json
docker-compose run --rm freqtrade backtesting --datadir user_data/data/binance --config user_data/config.json --export trades -s GuruSkippyasurmuni --fee 0.00075 --timerange=20231001-20240203 --breakdown day --eps
docker-compose run --rm freqtrade hyperopt --datadir user_data/data/binance --config user_data/config.json --strategy GuruSkippyasurmuni --hyperopt-loss SortinoHyperOptLossDaily --spaces roi buy sell --timerange=20230101-20231231 -j 6 -e 1000
