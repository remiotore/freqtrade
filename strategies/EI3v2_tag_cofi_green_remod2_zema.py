...
class EI3v2_tag_cofi_green_remod2_zema(IStrategy):
    ...
    plot_config = {
        'main_plot': {
            'ma_buy_12': {'color': '#00e676'}, #verde
            'ma_sell_22': {'color': '#f44336'}, #rosso
            'hma_50': {'color': '#795548'}, #marrone
            'sma_9': {'color': '#9c27b0'}, #viola 
            'EWO': {'color': '#3f51b5'}, # blu
            'rsi': {'color': '#fff59d'}, # giallo 200
            'rsi_fast': {'color': '#fdd835'}, # giallo 600
            'rsi_slow': {'color': '#f9a825'}, # giallo 800
        },
    }
