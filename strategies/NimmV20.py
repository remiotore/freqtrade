...
class NimmV20(IStrategy):
    ...
    buy_params = {
        ...
        "buy_min_fan_magnitude_gain": 1.005 # NOTE: Good value (Win% ~70%), alot of trades
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe['sma5'] = ta.SMA(dataframe, timeperiod=20)        
        dataframe['above_trendline'] = np.where(dataframe['close'] > dataframe['sma5'], 1, 0)        
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(dataframe['above_trendline'] == 1)
