...
class E0V1E(IStrategy):
    ...
    #
    minimal_roi = {
        "0": 0.10,   # +10% antes de 60 min
        "60": 0.04,  # +4% entre 60 y 120 min
        "120": 0.02, # +2% entre 120 y 240 min
        "240": 0     # tras 240 min, sin mínimo
    }
    ...
    #
    # 6) Custom Stoploss (con break even)
    #
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
                        current_rate: float, current_profit: float, **kwargs) -> float:
        
        # Mueve stop a 0% si llevas +3%
        ...
        # Dejar None para no cambiar si no se cumplen condiciones
        return None
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', 
        ...
        # Regla extra: si RSI > 80, cierra para asegurar ganancia
    ...
    #
    # 10) populate_exit_trend base
    #
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[:, ['exit_long', 'exit_tag']] = (0, 'long_out')
        return dataframe

# hash(sha256): a1ce4ba5b7476414d68a11ad278fca0e5cc51a5ed3ad7006def3c3850ee6410d
# last change: 2024-12-01 20:31:52
