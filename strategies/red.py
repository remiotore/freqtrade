...
class red(IStrategy):
    ...
    cci_buy = IntParameter(-200, 200, default=-100, space="buy")
    cci_candles_buy = IntParameter(10, 80, default=60, space="buy")

    rsi_buy = IntParameter(10, 90, default=30, space="buy")
    rsi_candles_buy = IntParameter(10, 80, default=26, space="buy")
    ...
    ewo_candles_buy = IntParameter(
        2,
        30,
        default=buy_params["ewo_candles_buy"],
        space="buy",
    )
    ...
    ewo_1_rsi_14 = IntParameter(
        10,
        100,
        default=buy_params["ewo_1_rsi_14"],
        space="buy",
    )
    ewo_1_rsi_4 = IntParameter(
        1,
        50,
        default=buy_params["ewo_1_rsi_4"],
        space="buy",
    )
    ewo_low_rsi_4 = IntParameter(
        1,
        50,
        default=buy_params["ewo_low_rsi_4"],
        space="buy",
    )
    ...
    cofi_ema = DecimalParameter(
        0.6,
        1.4,
        default=buy_params["cofi_ema"],
        space="buy",
    )
    cofi_fastk = IntParameter(
        1,
        100,
        default=buy_params["cofi_fastk"],
        space="buy",
    )
    cofi_fastd = IntParameter(
        1,
        100,
        default=buy_params["cofi_fastd"],
        space="buy",
    )
    cofi_adx = IntParameter(
        1,
        100,
        default=buy_params["cofi_adx"],
        space="buy",
    )
    ...
    nfi32_rsi_4 = IntParameter(
        1,
        100,
        default=buy_params["nfi32_rsi_4"],
        space="buy",
    )
    ...
    buy_btc_safe_1d = DecimalParameter(
        -0.5,
        -0.015,
        default=buy_params["buy_btc_safe_1d"],
    )
    ...
    ewo_1_enabled = BooleanParameter(
        default=buy_params["ewo_1_enabled"],
        space="buy",
    )
    ewo_low_enabled = BooleanParameter(
        default=buy_params["ewo_low_enabled"],
        space="buy",
    )
    cofi_enabled = BooleanParameter(
        default=buy_params["cofi_enabled"],
        space="buy",
    )
    lambo1_enabled = BooleanParameter(
        default=buy_params["lambo1_enabled"],
        space="buy",
    )
    lambo2_enabled = BooleanParameter(
        default=buy_params["lambo2_enabled"],
        space="buy",
    )
    ...
    nfi32_enabled = BooleanParameter(
        default=buy_params["nfi32_enabled"],
        space="buy",
    )
    clucha_enabled = BooleanParameter(
        default=buy_params["clucha_enabled"],
        space="buy",
    )
    ...
    @informative("1h")
    def populate_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe[f"cci_buy_{self.cci_candles_buy.value}"] = ta.CCI(
            dataframe, timeperiod=self.cci_candles_buy.value
        )
        dataframe[f"rsi_buy_{self.rsi_candles_buy.value}"] = ta.RSI(
            dataframe, timeperiod=self.rsi_candles_buy.value
        )
        ...
        rsiCCI = dataframe[
            f"rsi_buy_{self.rsi_candles_buy.value}"
        ] < self.rsi_buy.value & (
            dataframe[f"cci_buy_{self.cci_candles_buy.value}"] < self.cci_buy.value
        )
        dataframe.loc[rsiCCI, "buy_tag"] += "rsi+cci_"
        conditions.append(rsiCCI)
...
class RED_DYNAMIC_TB(red):
    process_only_new_candles = True

    custom_info_trail_buy: Dict = dict()
