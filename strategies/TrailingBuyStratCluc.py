...
class ClucHAnix_ETH(TrailingBuyStratCluc):
...
class ClucHAnix_BTC(TrailingBuyStratCluc):
...
class ClucHAnix_USD(TrailingBuyStratCluc):
...
class TrailingBuyStratCluc(TrailingBuyStratCluc):
