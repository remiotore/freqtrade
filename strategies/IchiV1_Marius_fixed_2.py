...
class IchiV1_Marius_fixed_2(IStrategy):
    ...
    def informative_pairs(self):
        ...
        informative_pairs += [("BTC/BUSD", "1m")]
        informative_pairs += [("BTC/BUSD", "5m")]
        informative_pairs += [("BTC/BUSD", "1d")]
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['btc_5m']= self.dp.get_pair_dataframe('BTC/BUSD', timeframe='5m')['close']
        btc_1d = self.dp.get_pair_dataframe('BTC/BUSD', timeframe='1d')[['date', 'close']].rename(columns={"close": "btc"}).shift(1)
        dataframe = merge_informative_pair(dataframe, btc_1d, '5m', '1d', ffill=True)

        informative = self.dp.get_pair_dataframe(pair="BTC/BUSD", timeframe="5m")
