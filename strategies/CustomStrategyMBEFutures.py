...
class CustomStrategy(IStrategy):
    ...
    stoploss = -0.7  # Tighter initial stop-loss
    trailing_stop = False
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        (
            ...
            (dataframe['trend_close_5m'] > dataframe['sma200']) &  # Price above 200-period SMA
            (dataframe['adx'] > 25) &  # ADX above 20 for trend strength
    ...
    def leverage(self, pair: str, current_time: datetime, current_rate: float,
        ...
        if proposed_leverage > 1.0:
            dynamic_leverage *= 1.9  # Augmenter le levier si le levier proposé est supérieur à 1
        else:
