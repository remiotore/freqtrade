...
class EI3v2_tag_cofi_green_rknfish(IStrategy):
    INTERFACE_VERSION = 3
    ...
    buy_params = {
        ...
        "buy_adx": 20,  # value loaded from strategy
        "buy_ema_cofi": 0.98,  # value loaded from strategy
        "buy_ewo_high": 4.179,  # value loaded from strategy
        "buy_fastd": 20,  # value loaded from strategy
        "buy_fastk": 22,  # value loaded from strategy
    ...
    minimal_roi = {"0": 0.136, "39": 0.093, "98": 0.029, "216": 0}

    stoploss = -0.282

    trailing_stop = True
    trailing_stop_positive = 0.186
    trailing_stop_positive_offset = 0.269
...
class EI3v2_tag_cofi_dca_green(EI3v2_tag_cofi_green_rknfish):
