...
class VWAPStrategy_16(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: 'Trade', current_profit: float, **kwargs) -> float:
        ...
        if current_profit >= 0.01:
            ...
            new_stoploss = current_profit / 2
            if new_stoploss > trade.stop_loss:
                return new_stoploss
