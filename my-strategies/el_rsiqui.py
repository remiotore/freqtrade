...
class el_rsiqui(IStrategy):
    ...
    rsi_entry_long = IntParameter(0, 50, default=30, space='entry', optimize=True)
    rsi_entry_short = IntParameter(50, 100, default=70, space='entry', optimize=True)
    rsi_exit_long = IntParameter(50, 100, default=60, space='exit', optimize=True)
    rsi_exit_short = IntParameter(0, 50, default=40, space='exit', optimize=True)
