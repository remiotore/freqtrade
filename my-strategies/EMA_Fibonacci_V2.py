...
class EMA_Fibonacci_V2(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def plot_config(self):
        plot_config = {
            'main_plot' : {
                ...
                'ema_55'  : { 'color': '#727272' }, 
                'ema_89'  : { 'color': '#7A7A7A' }, 
                'ema_144' : { 'color': '#828282' }, 
                'ema_233' : { 'color': '#8A8A8A' }, 
                'ema_377' : { 'color': '#929292' }, 
            },
            'subplots' : {
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['ema_377'] = ta.EMA(dataframe['typ'], 377)
        ...
        dataframe['pdi_377'] = ta.PLUS_DI(dataframe, 377)
        ...
        dataframe['mdi_377'] = ta.MINUS_DI(dataframe, 377)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[
            (
                ...
                (dataframe['ema_89']  > dataframe['ema_144']) &
                (dataframe['ema_144'] > dataframe['ema_233']) &
                ...
                (dataframe['pdi_233'] > dataframe['pdi_377']) &

                (dataframe['mdi_233'] > dataframe['mdi_377']) &
                ...
                (dataframe['pdi_34']  > dataframe['mdi_34']) &
                (dataframe['pdi_55']  > dataframe['mdi_55']) &
                (dataframe['pdi_89']  > dataframe['mdi_89']) &
                (dataframe['pdi_144'] > dataframe['mdi_144']) &
                (dataframe['pdi_233'] > dataframe['mdi_233']) &
                (dataframe['pdi_377'] > dataframe['mdi_377']) 
            ),
        'enter_long'] = 1
        ...
        dataframe.loc[
            (
                ...
                (dataframe['ema_233'] < dataframe['ema_377']) &
                (dataframe['ema_144'] < dataframe['ema_233']) &
                (dataframe['ema_89']  < dataframe['ema_144']) &
                (dataframe['ema_55']  < dataframe['ema_89'])  &
                (dataframe['ema_34']  < dataframe['ema_55'])  &
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(
            (dataframe['typ'] < dataframe['ema_34'])
        ), 'exit_long'] = 1
